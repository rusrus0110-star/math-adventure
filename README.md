...
- Only visible, focused question-solving time counts, with a 30-second interaction timeout. Bonus-Spiel itself is not yet a playable route in this checkout; the persisted bank and spending repository are ready for its integration.
